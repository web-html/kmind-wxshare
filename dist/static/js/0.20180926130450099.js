...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Download_vue__ = __webpack_require__(84);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__User_vue__ = __webpack_require__(89);
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Footer_vue__ = __webpack_require__(94);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utils_request__ = __webpack_require__(66);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__common_Download__ = __webpack_require__(68);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__common_User__ = __webpack_require__(69);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__common_FooterCode__ = __webpack_require__(70);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utils_request_js__ = __webpack_require__(66);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__api_route_js__ = __webpack_require__(71);
//
//
//
//
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__download_less__ = __webpack_require__(86);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_arouse__ = __webpack_require__(74);
//
//
//
//
...
var update = __webpack_require__(64)("602cb454", content, true, {});
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__user_less__ = __webpack_require__(91);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(64)("6049bdda", content, true, {});
...
// module
exports.push([module.i, ".user-wrap dl dt{width:2rem;height:2rem;margin-right:.5rem}.user-wrap dl dt img{width:100%;height:100%;border-radius:50%}.user-wrap dl dd{font-family:PingFangSC-Regular;font-size:.7rem;letter-spacing:.88px}.user-wrap dl dd p.p-name{line-height:1rem}.user-wrap dl dd p.p-desc{font-size:.55rem;color:#8b9096;letter-spacing:.69px}.user-wrap dl dd p.p-desc span{font-family:PingFangSC-Semibold;color:#000;font-size:.55rem;letter-spacing:.69px;line-height:.75rem}", ""]);
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__footer_less__ = __webpack_require__(96);
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(64)("7af1af60", content, true, {});
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__common_User__ = __webpack_require__(69);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__common_FooterCode__ = __webpack_require__(70);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__api_route__ = __webpack_require__(71);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__utils_wx__ = __webpack_require__(102);
//
//
//
//
...
const poiscan = __webpack_require__(77);
const adventure = __webpack_require__(104);
const art = __webpack_require__(105);
const culture = __webpack_require__(106);
const entertainment = __webpack_require__(107);
const food = __webpack_require__(108);
const landscape = __webpack_require__(109);
const night = __webpack_require__(110);
const water = __webpack_require__(111);
/* harmony default export */ __webpack_exports__["default"] = ({
  name: "announcement",
  props: ["type", "id", "userId", "uuid"],
  data() {
    ...
    getTrack() {
      Object(__WEBPACK_IMPORTED_MODULE_3__api_route__["d" /* getTrack */])({ id: this.id }).then(res => {
        if (res.data.code == 200) {
          ...
          this.description = poiProfileDTO.description ? poiProfileDTO.description : "";
          this.trackname = poiProfileDTO.name;
          let img = poiProfileDTO.mainDimension != "" && poiProfileDTO.mainDimension != null ? this.iconObj[poiProfileDTO.mainDimension] : false;
          this.iconSrc = img;
          this.getUserInfo();
        }
      }).catch(res => {
...
"use strict";
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_weixin_js_sdk__ = __webpack_require__(103);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__utils_request__ = __webpack_require__(66);
/**
...
module.exports={render:function (){var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;
  ...
  }) : _vm._e()]), _vm._v(" "), _c('dd', [_vm._v(_vm._s(_vm.trackname))])])]), _vm._v(" "), _c('footer-code')], 1)], 1)
},staticRenderFns: []}
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__common_FooterCode__ = __webpack_require__(70);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__api_route__ = __webpack_require__(71);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_4__api_weixin__ = __webpack_require__(114);
//
//
//
//
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(64)("15417fea", content, true, {});
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__utils_arouse__ = __webpack_require__(74);
//
//
//
//
...
/* harmony default export */ __webpack_exports__["default"] = ({
  ...
  methods: {
    download() {
      let config = {
        // 和app协定的scheme
        ioschema: "AnyGo.1000mind://anygo/",
        andschema: "scheme://com.kmiles.chuqu/anygo/",
        // iOS下的App在appstore的地址
        appstore: "http://itunes.apple.com/app/id1345961107?mt=8",
        // 应用宝的地址
        yyb: "http://download.awayroadtrip.com/chuqu.apk"
      ...
      // alert(config.schema)
      let applink = new __WEBPACK_IMPORTED_MODULE_0__utils_arouse__["a" /* AppLink */](config);
      applink.open();
    }
  }
});
...
if(content.locals) module.exports = content.locals;
// add the styles to the DOM
var update = __webpack_require__(64)("1fcc4dbd", content, true, {});
...
"use strict";
Object.defineProperty(__webpack_exports__, "__esModule", { value: true });
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__Announcement__ = __webpack_require__(67);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__Footprint__ = __webpack_require__(72);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__Journey__ = __webpack_require__(73);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_3__utils_operation__ = __webpack_require__(127);
//
//
//
//
